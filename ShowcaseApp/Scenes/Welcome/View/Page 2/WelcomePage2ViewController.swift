...
final class WelcomePage2ViewController: UIViewController {
    ...
    var viewModel: WelcomePage2ViewModel!
    ...
    private func bind(_ viewModel: WelcomePage2ViewModel) {
        // Input
        ...
        let input = WelcomePage2ViewModel.Input(
            loadEvent: loadEvent,
            prevEvent: prevEvent,
            nextEvent: nextEvent,
    ...
    private func bind(_ vmo: WelcomePage2ViewModelOutput) {
    ...
    private func bind(_ bio: WelcomePage2ViewModelOutput.Bio) {
        viewBioStack
            .arrangedSubviews
    ...
    private func show(view type: WelcomePage2ViewModelOutput.ViewState) {
        let animations: () -> Void
